...
public class AlertsystemTestContainerERPDB extends TestContainer {

    public AlertsystemTestContainerERPDB() {
        super();
        ...
        dbUrl ="jdbc:sqlserver://10.17.0.1;databaseName=ERPDB";
        dbUser = "sample_track";
    ...
    public static class Common extends AlertsystemTestContainerERPDB {

        public static final AlertsystemTestContainerERPDB.Common INSTANCE = new AlertsystemTestContainerERPDB.Common();
